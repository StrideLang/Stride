...
on tile[DSP_TILE] : r_i2s i2s_resource_s =
{
    XS1_CLKBLK_1,
    XS1_CLKBLK_2,
...
on tile[DSP_TILE] : port p_i2c = PORT_I2C;
on tile[DSP_TILE] : out port p_gpio = PORT_GPIO;
#ifndef SINGLE_TILE
on tile[DSP_TILE] : port dsp_led1 = XS1_PORT_1D;
on tile[DSP_TILE] : port dsp_led2 = XS1_PORT_1A;
#endif
