...
//    NewSignal >> Level(gain: 1.0) >> NewSignal2;
    ...
    list = static_cast<ListNode *>(stream->getLeft());
    Q_ASSERT(list->getNodeType() == AST::List);
    Q_ASSERT(list->size() == 2);
    bundle = static_cast<BundleNode *>(list->getChildren().at(0));
    Q_ASSERT(bundle->getNodeType() == AST::Bundle);
    Q_ASSERT(bundle->getName() == "Out");
    ...
    Q_ASSERT(value->getNodeType() == AST::Int);
    Q_ASSERT(value->getIntValue() == 1);
    ...
    Q_ASSERT(func->getNodeType() == AST::Function);
    Q_ASSERT(func->getName() == "Level");
    value = static_cast<ValueNode *>(func->getPropertyValue("gain"));
    Q_ASSERT(value->getNodeType() == AST::Real);
    Q_ASSERT(value->getRealValue() == 1.0);
    ...
    bundle = static_cast<BundleNode *>(list->getChildren().at(0));
    Q_ASSERT(bundle->getNodeType() == AST::Bundle);
    Q_ASSERT(bundle->getName() == "NewSignal");
    indexList = static_cast<ListNode *>(bundle->index());
    Q_ASSERT(indexList->size() == 1);
    value = static_cast<ValueNode *>(indexList->getChildren().at(0));
    Q_ASSERT(value->getNodeType() == AST::Int);
    ...
    bundle = static_cast<BundleNode *>(list->getChildren().at(0));
    Q_ASSERT(bundle->getNodeType() == AST::Bundle);
    Q_ASSERT(bundle->getName() == "NewSignal2");
    indexList = static_cast<ListNode *>(bundle->index());
    Q_ASSERT(indexList->size() == 1);
    value = static_cast<ValueNode *>(indexList->getChildren().at(0));
    Q_ASSERT(value->getNodeType() == AST::Int);
    ...
    func = static_cast<FunctionNode *>(list->getChildren().at(0));
    Q_ASSERT(func->getNodeType() == AST::Function);
    Q_ASSERT(func->getName() == "Oscillator");
    value = static_cast<ValueNode *>(func->getPropertyValue("frequency"));
    Q_ASSERT(value->getNodeType() == AST::Int);
    Q_ASSERT(value->getIntValue() == 440);
    func = static_cast<FunctionNode *>(list->getChildren().at(1));
    Q_ASSERT(func->getNodeType() == AST::Function);
    Q_ASSERT(func->getName() == "Oscillator");
    value = static_cast<ValueNode *>(func->getPropertyValue("frequency"));
