...
#        '''
    ...
    '''
        ...
        config_template_code = config_template_code.replace("%%num_out_chnls%%", str(self.properties['num_out_chnls']))
        config_template_code = config_template_code.replace("%%num_in_chnls%%", str(self.properties['num_in_chnls']))
